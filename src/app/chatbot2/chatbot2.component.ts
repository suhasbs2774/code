...
@Component({
  ...
  styleUrl: './chatbot2.component.css'
})
export class Chatbot2Component {
  ...
  submitReview2(): void {
    ...
    constructor(private router:Router) {
     ...
     gotoCard1() {
      this.router.navigate(['/card1']);  // define your component where you want to go
     }
     gotoCard2() {
